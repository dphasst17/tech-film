...
const Widget = () => {
    ...
    return <div className={`fixed ${isLock ? 'w-screen h-screen bottom-0 left-0' : 'w-[10vw] h-[50px] bottom-2 px-2'} min-w-[250px] transition-all mx-auto flex flex-wrap justify-start items-center z-50`}>
